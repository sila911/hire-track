      ...
      <div className="relative z-10">
        ...
        <div className="mt-4 flex gap-2 border-t border-white/10 pt-4">
          <button
            ...
            className="flex-1 rounded-xl border border-white/15 bg-white/5 py-2 text-xs font-bold text-white/90 transition hover:bg-white/10"
          >
            Edit
          </button>
          <button
            ...
            className="flex-1 rounded-xl border border-red-400/25 bg-red-500/10 py-2 text-xs font-bold text-red-200 transition hover:bg-red-500/20"
          >
            Delete
          </button>
        </div>
